...
def parser_opt(model):
    ...
    if model == 'train':
        ...
        args.train_data_files = os.path.join(args.data_dir,'train')
        args.val_data_files = os.path.join(args.data_dir, 'val')
        args.test_data_files = os.path.join(args.data_dir, 'test')
        ...
        args.input_vocab_size = os.environ.get('input_vocab_size')
        ...
        args.rnn_size = int(os.environ.get('rnn_size'))
    elif model =='env':
        pass
    elif model == 'server':
        args.network_name = os.environ.get('network_name')
